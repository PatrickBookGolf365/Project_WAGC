...
var WeatherService = /** @class */ (function () {
    function WeatherService(_http) {
        ...
        this._weatherCurrent = 'http://api.openweathermap.org/data/2.5/weather?lat=53.3909&lon=-6.5665&units=metric&appid=6864244ceeeaa2b28fad8845b7113272';
        // tslint:disable-next-line:max-line-length
    ...
    WeatherService.prototype.getWeather = function () {
        return this._http.get(this._weatherCurrent)
            .do(function (data) { return console.log("Weather: " + JSON.stringify(data)); })
            .catch(this.handleError);
    };
