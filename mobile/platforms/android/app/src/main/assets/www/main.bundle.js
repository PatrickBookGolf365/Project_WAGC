...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_live_score_live_score_service__ = __webpack_require__("./src/app/components/live-score/live-score.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_live_score_live_player_score_live_player_score_component__ = __webpack_require__("./src/app/components/live-score/live-player-score/live-player-score.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_live_score_live_team_score_live_team_score_component__ = __webpack_require__("./src/app/components/live-score/live-team-score/live-team-score.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_27__components_live_score_live_player_score_live_player_score_component__["a" /* LivePlayerScoreComponent */],
                __WEBPACK_IMPORTED_MODULE_28__components_live_score_live_team_score_live_team_score_component__["a" /* LiveTeamScoreComponent */]
            ],
            imports: [
...
module.exports = "<div id=\"headerImg\">\r\n  <img src=\"./assets/img/WATC.jpg\">\r\n</div>\r\n\r\n<div id=\"weather-api\">\r\n  <!-- <mat-toolbar id=\"weather-toolbar\">\r\n    <div id=\"forecast\">\r\n      <span>\r\n        {{weather.main.temp | number:'1.0-0'}}&deg;c\r\n      </span>\r\n\r\n    </div><div id=\"wind\">\r\n      <!-- make button to change to fareinhit -->\r\n      <!-- <span>Wind: {{weather.wind.speed | number:'1.0-0'}} km/h</span>\r\n      <div id=\"direction\">\r\n        <span *ngIf=\"weather.wind.deg >= 0 && weather.wind.deg <= 22.50\">\r\n          North\r\n        </span>\r\n        <div *ngIf=\"weather.wind.deg > 22.50 && weather.wind.deg <= 67.50\">\r\n          North-East\r\n        </div>\r\n        <span *ngIf=\"weather.wind.deg > 67.50 && weather.wind.deg <= 112.50\">\r\n          East\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 112.50 && weather.wind.deg <= 157.50\">\r\n          South-East\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 157.50 && weather.wind.deg <= 202.50\">\r\n          South\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 202.50 && weather.wind.deg <= 247.50\">\r\n          South-West\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 247.50 && weather.wind.deg <= 292.50\">\r\n          West\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 292.50 && weather.wind.deg <= 337.50\">\r\n          North-West\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg > 337.50 && weather.wind.deg <= 360\">\r\n          North\r\n        </span>\r\n        <span *ngIf=\"weather.wind.deg == null\">\r\n          Calm wind\r\n        </span>\r\n      </div>\r\n    </div>\r\n  </mat-toolbar> -->\r\n  <div class=\"flex-container\">\r\n      <div class=\"flex-item\">\r\n        <div clas=\"flex-temp\">\r\n          <span>{{weather.main.temp | number:'1.0-0'}}&deg;c</span>\r\n        </div>\r\n        <div class=\"flex-temp\">\r\n          <span class=\"small\"><mat-icon class=\"up\">arrow_drop_up</mat-icon>{{weather.main.temp_max | number:'1.0-0'}}&deg;</span> <span class=\"small\">{{weather.main.temp_min | number:'1.0-0'}}&deg;<mat-icon class=\"down\">arrow_drop_down</mat-icon></span>\r\n        </div>\r\n      </div>\r\n      <div class=\"flex-item\">\r\n        <div class=\"flex-wind\">\r\n          <span class=\"wind-text\">{{weather.wind.speed | number:'1.0-0'}} km/h</span>\r\n        </div>\r\n        <div clas=\"flex-wind\">\r\n          <span class=\"wind-small\">{{weather.weather[0].main}}</span>\r\n        </div>\r\n      </div>\r\n      <div class=\"flex-item\">\r\n        <div class=\"flex-direction\">\r\n          <span *ngIf=\"weather.wind.deg >= 0 && weather.wind.deg <= 22.50\"><!--N-->\r\n           <mat-icon><img class=\"compass-img\" src=\"./assets/img/north.png\"></mat-icon>\r\n          </span>\r\n          <div *ngIf=\"weather.wind.deg > 22.50 && weather.wind.deg <= 67.50\"><!--NE-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/north.png\"></mat-icon>\r\n          </div>\r\n          <span *ngIf=\"weather.wind.deg > 67.50 && weather.wind.deg <= 112.50\"><!--E-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/east.png\"></mat-icon>\r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 112.50 && weather.wind.deg <= 157.50\"><!--SE-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/east.png\"></mat-icon>\r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 157.50 && weather.wind.deg <= 202.50\"> <!--S-->\r\n            <mat-icon><img  class=\"compass-img\" src=\"./assets/img/south.png\"></mat-icon> \r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 202.50 && weather.wind.deg <= 247.50\"> <!--SW-->\r\n            <mat-icon><img  class=\"compass-img\" src=\"./assets/img/south.png\"></mat-icon>           \r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 247.50 && weather.wind.deg <= 292.50\"><!--W-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/west.png\"></mat-icon>\r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 292.50 && weather.wind.deg <= 337.50\"><!--NW-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/west.png\"></mat-icon>\r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg > 337.50 && weather.wind.deg <= 360\"><!--N-->\r\n            <mat-icon><img class=\"compass-img\" src=\"./assets/img/north.png\"></mat-icon>\r\n          </span>\r\n          <span *ngIf=\"weather.wind.deg == null\">\r\n            Calm\r\n          </span>\r\n          </div>\r\n      </div>\r\n  </div>\r\n\r\n  <mat-list class=\"news-content-wrapper\">\r\n      <mat-list-item class=\"mat-item\">\r\n\r\n          \r\n      <img src=\"./assets/img/ILGU.png\" class=\"mat-item-img\">\r\n          \r\n\r\n    <div class=\"mat-item-content\">\r\n         <div class=\"mat-item-heading\">\r\n             <h3>Heading</h3>\r\n          </div>\r\n                  \r\n          <div class=\"mat-item-para\">\r\n            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>\r\n          </div>\r\n        </div>\r\n      </mat-list-item>\r\n    \r\n      <mat-divider></mat-divider>\r\n\r\n</mat-list>\r\n\r\n"
            ...
            animations: [
                Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["m" /* trigger */])('fade', [
                    Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["l" /* transition */])('void => *', [
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["e" /* animate */])(2000, Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["k" /* style */])({ opacity: 1 }))
                    ])
                ])
            ]
        }),
...
module.exports = "<div id=\"live-main\">\n  <mat-toolbar id=\"live-search\">\n    <mat-form-field>\n      <input matInput placeholder=\"search\">\n    </mat-form-field>\n    <span class=\"example-fill-remaining-space\"></span>\n    <button mat-button>\n      <mat-icon>search</mat-icon>\n    </button>\n  </mat-toolbar>\n  <div >\n    \n  </div>\n  <table id=\"live-table\">\n    <thead>\n      <tr id=\"live-table-header-title\">\n        <th>Pos</th>\n        <th>Player</th>\n        <th>Team</th>\n        <th>Hole</th>\n        <th>Total</th>\n        <th>R1</th>\n        <th>R2</th>\n        <th>R3</th>\n        <th>R4</th>\n        <th>Total</th>\n      </tr>\n    </thead>\n    <tbody id=\"player-tbody\" *ngFor=\"let number of numbers; let i = index\" > \n      <tr *ngFor=\"let players of player\">\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].Pos[0]}}</td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].Name[0]}}</td>\n        <td><img src=\"./assets/img/{{players.ScoringResult.Results[0].ScoreItem[i].Display[0]}}.png\"></td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].Hole[0]}}</td>\n        <td>\n              <span id=\"total_{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}\">{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}</span>\n\n          <!-- <div *ngIf=\"players.ScoringResult.Results[0].ScoreItem[i].TotalToPar == +2\">\n              <span id=\"total_plus\">{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}</span>\n            </div>\n            <div *ngIf=\"players.ScoringResult.Results[0].ScoreItem[i].TotalToPar == +3\">\n                <span id=\"total_plus\">{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}</span>\n              </div>\n              <div *ngIf=\"players.ScoringResult.Results[0].ScoreItem[i].TotalToPar == +4\">\n                  <span id=\"total_plus\">{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}</span>\n                </div>\n                <div *ngIf=\"players.ScoringResult.Results[0].ScoreItem[i].TotalToPar == +5\">\n                    <span id=\"total_plus\">{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}</span>\n                  </div> -->\n        </td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].RoundScore[0].string[0]}}</td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].RoundScore[0].string[1]}}</td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].RoundScore[0].string[2]}}</td>\n        <td>{{players.ScoringResult.Results[0].ScoreItem[i].RoundScore[0].string[3]}}</td>\n        <td>\n          <span id=\"total_{{players.ScoringResult.Results[0].ScoreItem[i].TotalToPar}}\">{{players.ScoringResult.Results[0].ScoreItem[i].Total}}</span>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n</div>\n"
...
var LiveScoreService = /** @class */ (function () {
    ...
    LiveScoreService.prototype.getTeam = function () {
        return this._http.get(this._faketeamUrl)
            .do(function (data) { return console.log("getTeam:" + JSON.stringify(data)); })
            .catch(this.handleError);
    };
...
module.exports = "<div *ngIf=\"hideall\">   \n<div id=\"team-wrapper\">\n  <mat-toolbar id=\"team-header-toolbar\">\n    <span><button class=\"hide-btn\" (click)=\"hideall = !hideall\"><mat-icon>arrow_back</mat-icon></button></span><span id=\"title\">{{team[p].team}}</span>\n    <button id=\"fav-button\" mat-button><mat-icon class=\"fav\">star</mat-icon></button>\n  </mat-toolbar>\n  <div id=\"team-header\">\n    <span>\n      <img id=\"team-image\" src=\"./assets/img/team.jpg\">\n    </span>\n    <mat-card id=\"score-Info\">\n      <table>\n      <tr>\n        <th>Thru</th><td>F</td>\n        <th>Today</th><td>-13</td>\n        <th>Total</th><td>-38</td>\n        <th>Rank</th><td>1</td>\n      </tr>\n    </table>\n    </mat-card>\n  </div>\n <mat-divider></mat-divider>\n  <div id=\"team-body\">\n    <mat-expansion-panel>\n      <mat-expansion-panel-header>\n        <mat-panel-title>\n          Round One\n        </mat-panel-title>\n      </mat-expansion-panel-header>\n      <div id=\"full-Table\">\n        <div id=\"static-Table\">\n          <table>\n            <!-- Header 1/2 -->\n            <tr>\n              <th>Hole</th>\n            </tr>\n            <tr>\n              <td>Yards</td>\n            </tr>\n            <tr>\n              <td>Par</td>\n            </tr>\n            <tr>\n              <td>{{team[p].player1.name}}</td>\n            </tr>\n            <tr>\n              <td>{{team[p].player2.name}}</td>\n            </tr>\n            <tr>\n              <td>{{team[p].player3.name}}</td>\n            </tr>\n            <tr>\n              <td>Complete</td>\n            </tr>\n            <tr>\n              <td>Score Against Par</td>\n            </tr>\n          </table>\n        </div>\n        <div class=\"scrolling-wrapper\">\n          <div id=\"moving-Table\">\n            <div class=\"card\">\n              <table class=\"playerScore\">\n                <tr>\n                  <!-- Header 2/2 -->\n                  <th>1</th>\n                  <th>2</th>\n                  <th>3</th>\n                  <th>4</th>\n                  <th>5</th>\n                  <th>6</th>\n                  <th>7</th>\n                  <th>8</th>\n                  <th>9</th>\n                  <th>10</th>\n                  <th>Out</th>\n                  <th>11</th>\n                  <th>12</th>\n                  <th>13</th>\n                  <th>14</th>\n                  <th>15</th>\n                  <th>16</th>\n                  <th>17</th>\n                  <th>18</th>\n                  <th>In</th>\n                  <th>Total</th>\n                </tr>\n                <tbody *ngFor=\"let players of player\">\n                <tr>\n                  <!-- Yards -->\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[0]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[1]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[2]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[3]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[4]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[5]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[6]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[7]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[8]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[9]}}</td>\n                  <td></td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[10]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[11]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[12]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[13]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[14]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[15]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[16]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Yards[0].int[17]}}</td>\n                  <td></td>\n                  <td></td>\n                </tr>\n\n                <tr>\n                  <!-- Par  -->\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[0]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[1]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[2]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[3]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[4]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[5]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[6]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[7]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[8]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[9]}}</td>\n                  <td></td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[10]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[11]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[12]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[13]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[14]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[15]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[16]}}</td>\n                  <td>{{players.ScoringResult.HBHTee[0].HBHTeeInfo[1].Par[0].int[17]}}</td>\n                  <td></td>\n                  <td></td>\n                </tr>\n\n                <tr>\n                  <!-- Player1  -->\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[0]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[1]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[2]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[3]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[4]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[5]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[6]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[7]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[8]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[9]}}</td>\n                  <td></td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[10]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[11]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[12]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[13]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[14]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[15]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[16]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[p].Score[0].string[17]}}</td>\n                  <td></td>\n                  <td></td>\n                </tr>\n\n                <tr>\n                  <!-- Player2  -->\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[0]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[1]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[2]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[3]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[4]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[5]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[6]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[7]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[8]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[9]}}</td>\n                  <td></td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[10]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[11]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[12]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[13]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[14]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[15]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[16]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[1].Score[0].string[17]}}</td>\n                  <td></td>\n                  <td></td>\n                </tr>\n\n                <tr>\n                  <!-- Player3  -->\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[0]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[1]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[2]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[3]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[4]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[5]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[6]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[7]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[8]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[9]}}</td>\n                  <td></td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[10]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[11]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[12]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[13]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[14]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[15]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[16]}}</td>\n                  <td>{{players.ScoringResult.Results[0].ScoreItem[0].HBH[0].HBHRound[0].Score[0].string[17]}}</td>\n                  <td></td>\n                  <td></td>\n                </tr>\n\n                <tr>\n                  <!-- Round  -->\n                  <td>9</td>\n                  <td>10</td>\n                  <td>6</td>\n                  <td>7</td>\n                  <td>8</td>\n                  <td>6</td>\n                  <td>6</td>\n                  <td>7</td>\n                  <td>8</td>\n                  <td>67</td>\n                  <td>8</td>\n                  <td>6</td>\n                  <td>9</td>\n                  <td>7</td>\n                  <td>8</td>\n                  <td>6</td>\n                  <td>8</td>\n                  <td>8</td>\n                  <td>8</td>\n                  <td>68</td>\n                  <td>135</td>\n                </tr>\n\n                <tr>\n                  <!-- Score Against Par  -->\n                  <td>-3</td>\n                  <td>-1</td>\n                  <td>-1</td>\n                  <td>-2</td>\n                  <td>-4</td>\n                  <td>-6</td>\n                  <td>-8</td>\n                  <td>-7</td>\n                  <td>-9</td>\n                  <td></td>\n                  <td>E</td>\n                  <td>E</td>\n                  <td>+1</td>\n                  <td>E</td>\n                  <td>-2</td>\n                  <td>-2</td>\n                  <td>-4</td>\n                  <td>-4</td>\n                  <td>-4</td>\n                  <td></td>\n                  <td>-9</td>\n                </tr>\n                </tbody>\n              </table>\n            </div>\n          </div>\n        </div>\n      </div>\n    </mat-expansion-panel>\n    <mat-divider></mat-divider>\n    <mat-expansion-panel>\n      <mat-expansion-panel-header>\n        <mat-panel-title>\n          Round Two\n        </mat-panel-title>\n      </mat-expansion-panel-header>\n      <div id=\"full-Table\">\n        <div id=\"static-Table\">\n          <table>\n            <!-- Header 1/2 -->\n            <tr>\n              <th>Hole</th>\n            </tr>\n            <tr>\n              <td>Yards</td>\n            </tr>\n            <tr>\n              <td>Par</td>\n            </tr>\n            <tr>\n              <td>Cameron Davis</td>\n            </tr>\n            <tr>\n              <td>Curtis Luck</td>\n            </tr>\n            <tr>\n              <td>Harrison Endycott</td>\n            </tr>\n            <tr>\n              <td>Complete</td>\n            </tr>\n            <tr>\n              <td>Score Against Par</td>\n            </tr>\n          </table>\n        </div>\n        <div class=\"scrolling-wrapper\">\n          <div id=\"moving-Table\">\n            <div class=\"card\">\n              <table class=\"playerScore\">\n                <tr>\n                  <!-- Header 1/2 -->\n                  <th>1</th>\n                  <th>2</th>\n                  <th>3</th>\n                  <th>4</th>\n                  <th>5</th>\n                  <th>6</th>\n                  <th>7</th>\n                  <th>8</th>\n                  <th>9</th>\n                  <th>10</th>\n                  <th>Out</th>\n                  <th>11</th>\n                  <th>12</th>\n                  <th>13</th>\n                  <th>14</th>\n                  <th>15</th>\n                  <th>16</th>\n                  <th>17</th>\n                  <th>18</th>\n                  <th>In</th>\n                  <th>Total</th>\n                </tr>\n\n                <tr>\n                  <!-- Yards -->\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                </tr>\n\n                <tr>\n                  <!-- Par  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player1  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player2  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player3  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Round  -->\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Score Against Par  -->\n                  <td>7</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n              </table>\n            </div>\n          </div>\n        </div>\n      </div>\n    </mat-expansion-panel>\n    <mat-divider></mat-divider>\n    <mat-expansion-panel>\n      <mat-expansion-panel-header>\n        <mat-panel-title>\n          Round Three\n        </mat-panel-title>\n      </mat-expansion-panel-header>\n      <div id=\"full-Table\">\n        <div id=\"static-Table\">\n          <table>\n            <!-- Header 1/2 -->\n            <tr>\n              <th>Hole</th>\n            </tr>\n            <tr>\n              <td>Yards</td>\n            </tr>\n            <tr>\n              <td>Par</td>\n            </tr>\n            <tr>\n              <td>Cameron Davis</td>\n            </tr>\n            <tr>\n              <td>Curtis Luck</td>\n            </tr>\n            <tr>\n              <td>Harrison Endycott</td>\n            </tr>\n            <tr>\n              <td>Complete</td>\n            </tr>\n            <tr>\n              <td>Score Against Par</td>\n            </tr>\n          </table>\n        </div>\n        <div class=\"scrolling-wrapper\">\n          <div id=\"moving-Table\">\n            <div class=\"card\">\n              <table class=\"playerScore\">\n                <tr>\n                  <!-- Header 1/2 -->\n                  <th>1</th>\n                  <th>2</th>\n                  <th>3</th>\n                  <th>4</th>\n                  <th>5</th>\n                  <th>6</th>\n                  <th>7</th>\n                  <th>8</th>\n                  <th>9</th>\n                  <th>10</th>\n                  <th>Out</th>\n                  <th>11</th>\n                  <th>12</th>\n                  <th>13</th>\n                  <th>14</th>\n                  <th>15</th>\n                  <th>16</th>\n                  <th>17</th>\n                  <th>18</th>\n                  <th>In</th>\n                  <th>Total</th>\n                </tr>\n\n                <tr>\n                  <!-- Yards -->\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                </tr>\n\n                <tr>\n                  <!-- Par  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player1  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player2  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player3  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Round  -->\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Score Against Par  -->\n                  <td>7</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n              </table>\n            </div>\n          </div>\n        </div>\n      </div>\n    </mat-expansion-panel>\n    <mat-divider></mat-divider>\n    <mat-expansion-panel>\n      <mat-expansion-panel-header>\n        <mat-panel-title>\n          Round Four\n        </mat-panel-title>\n      </mat-expansion-panel-header>\n      <div id=\"full-Table\">\n        <div id=\"static-Table\">\n          <table>\n            <!-- Header 1/2 -->\n            <tr>\n              <th>Hole</th>\n            </tr>\n            <tr>\n              <td>Yards</td>\n            </tr>\n            <tr>\n              <td>Par</td>\n            </tr>\n            <tr>\n              <td>Cameron Davis</td>\n            </tr>\n            <tr>\n              <td>Curtis Luck</td>\n            </tr>\n            <tr>\n              <td>Harrison Endycott</td>\n            </tr>\n            <tr>\n              <td>Complete</td>\n            </tr>\n            <tr>\n              <td>Score Against Par</td>\n            </tr>\n          </table>\n        </div>\n        <div class=\"scrolling-wrapper\">\n          <div id=\"moving-Table\">\n            <div class=\"card\">\n              <table class=\"playerScore\">\n                <tr>\n                  <!-- Header 1/2 -->\n                  <th>1</th>\n                  <th>2</th>\n                  <th>3</th>\n                  <th>4</th>\n                  <th>5</th>\n                  <th>6</th>\n                  <th>7</th>\n                  <th>8</th>\n                  <th>9</th>\n                  <th>10</th>\n                  <th>Out</th>\n                  <th>11</th>\n                  <th>12</th>\n                  <th>13</th>\n                  <th>14</th>\n                  <th>15</th>\n                  <th>16</th>\n                  <th>17</th>\n                  <th>18</th>\n                  <th>In</th>\n                  <th>Total</th>\n                </tr>\n\n                <tr>\n                  <!-- Yards -->\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                  <td>400</td>\n                </tr>\n\n                <tr>\n                  <!-- Par  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player1  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player2  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Player3  -->\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Round  -->\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n\n                <tr>\n                  <!-- Score Against Par  -->\n                  <td>7</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>5</td>\n                  <td>6</td>\n                </tr>\n              </table>\n            </div>\n          </div>\n        </div>\n      </div>\n    </mat-expansion-panel>\n    <div id=\"team-footer\">\n\n\n    </div>\n  </div>\n  </div>\n</div>\n<div id=\"live-main\" *ngIf=\"!hideall\">\n    <mat-toolbar id=\"live-search\">\n        <mat-form-field>\n            <input matInput placeholder=\"search\">\n        </mat-form-field>\n        <span class=\"example-fill-remaining-space\"></span>\n        <button mat-button>\n            <mat-icon>search</mat-icon>\n        </button>\n    </mat-toolbar>\n    <table id=\"live-table\">\n        <thead>\n            <tr id=\"live-table-header-title\">\n                <th></th>\n                <th>Pos</th>\n                <th>Team</th>\n                <th>Hole</th>\n                <th>Total</th>\n                <th>R1</th>\n                <th>R2</th>\n                <th>R3</th>\n                <th>R4</th>\n                <th>Total</th>\n            </tr>\n        </thead>\n        <tbody id=\"player-tbody\"*ngFor=\"let team of team; let x = index\" class=\"tbody\">\n            <tr id=\"live-table-header\">\n                <td>\n                    <button class=\"hide-btn\" (click)=\"hideStuff[x] = !hideStuff[x]\">\n                        <mat-icon>expand_{{hideStuff[x] ? 'less' : 'more'}}</mat-icon>\n                    </button>\n                </td>\n                <td>{{team.pos}}</td>\n                <td><button class=\"\" (click)=\"hideall = !hideall; p = [x]\" mat-button>{{team.team}}</button></td>\n                <td>{{team.hole}}</td>\n                <td>\n                    <span id=\"total\">{{team.total}}</span>\n                </td>\n                <td>{{team.r1}}</td>\n                <td>{{team.r2}}</td>\n                <td>{{team.r3}}</td>\n                <td>{{team.r4}}</td>\n                <td>\n                    <span id=\"total\">{{team.final}}</span>\n                </td>\n            </tr>\n\n            <!--player 1-->\n            <tr class=\"player\" *ngIf=\"hideStuff[x]\">\n                <td>{{x}}</td>\n                <td></td>\n                <td>{{team.player1.name}}</td>\n                <td>{{team.player1.hole}}</td>\n                <td>\n                    <span id=\"total\">{{team.player1.total}}</span>\n                </td>\n                <td>{{team.player1.r1}}</td>\n                <td>{{team.player1.r2}}</td>\n                <td>{{team.player1.r3}}</td>\n                <td>{{team.player1.r4}}</td>\n                <td>\n                    <span id=\"total\">{{team.player1.final}}</span>\n                </td>\n            </tr>\n\n            <!--player 2-->\n            <tr class=\"player\" *ngIf=\"hideStuff[x]\">\n                <td></td>\n                <td></td>\n                <td>{{team.player2.name}}</td>\n                <td>{{team.player2.hole}}</td>\n                <td>\n                    <span id=\"total\">{{team.player2.total}}</span>\n                </td>\n                <td>{{team.player2.r1}}</td>\n                <td>{{team.player2.r2}}</td>\n                <td>{{team.player2.r3}}</td>\n                <td>{{team.player2.r4}}</td>\n                <td>\n                    <span id=\"total\">{{team.player2.final}}</span>\n                </td>\n            </tr>\n            <!--player 3-->\n            <tr class=\"player\" *ngIf=\"hideStuff[x]\">\n                <td></td>\n                <td></td>\n                <td>{{team.player3.name}}</td>\n                <td>{{team.player3.hole}}</td>\n                <td>\n                    <span id=\"total\">{{team.player3.total}}</span>\n                </td>\n                <td>{{team.player3.r1}}</td>\n                <td>{{team.player3.r2}}</td>\n                <td>{{team.player3.r3}}</td>\n                <td>{{team.player3.r4}}</td>\n                <td>\n                    <span id=\"total\">{{team.player3.final}}</span>\n                </td>\n                <td></td>\n            </tr>\n        </tbody>\n    </table>\n    <mat-divider></mat-divider>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__live_score_live_score_service__ = __webpack_require__("./src/app/components/live-score/live-score.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TeamProfilesComponent = /** @class */ (function () {
    ...
    TeamProfilesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__live_score_live_score_service__["a" /* LiveScoreService */]])
